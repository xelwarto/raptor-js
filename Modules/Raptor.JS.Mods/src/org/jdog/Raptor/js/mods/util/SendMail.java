...
public class SendMail {
    ...
    public SendMail(String smtpServer, String smtpUser, String smtpPassword) {
        if (smtpServer != null) {
            this.smtpServer = smtpServer;
        ...
        if (addressList != null && !addressList.equals("")) {
            ...
            if (addresses != null) {
                for (int i = 0; i < addresses.length; i++) {
                    messageRecipients.add(_addRecipient(RecipientType.TO, addresses[i]));
                }
            }
        }
    }
    ...
    public void setMessageCC(String addressList) {
        if (addressList != null && !addressList.equals("")) {
            ...
            if (addresses != null) {
                for (int i = 0; i < addresses.length; i++) {
                    messageRecipients.add(_addRecipient(RecipientType.CC, addresses[i]));
                }
            }
        }
    }
    ...
    public void setMessageBCC(String addressList) {
        if (addressList != null && !addressList.equals("")) {
            ...
            if (addresses != null) {
                for (int i = 0; i < addresses.length; i++) {
                    messageRecipients.add(_addRecipient(RecipientType.BCC, addresses[i]));
                }
            }
        }
    }
    ...
    private HashMap<String, Object> _addRecipient(RecipientType type, String address) {
    ...
    private String findSmtpServer(String to) {
        ...
        try {
            ...
            errors.add("Unable to find smtp server for " + to + ": " + e.toString());
        }
        return smtpHost;
    }
        ...
        if (sendSingle) {
            ...
            if (session != null) {
                ...
                if (msg != null) {
                    ...
                    try {
                        InternetAddress mesgFrom = new InternetAddress(messageFrom);
                        if (mesgFrom != null) {
                        ...
                        if (session != null) {
                            ...
                            if (msg != null) {
                                try {
                                    ...
                                    errors.add("Add Msg Recipirnt - " + e.toString());
                                }
